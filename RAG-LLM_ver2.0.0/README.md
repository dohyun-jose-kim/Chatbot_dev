...
| 버전 | 내용 | 상태 |
|---|---|---|
| 2.0.1 | Multi-turn + LangChain + Ollama 전환 | 진행 중 |
| 2.2.0 | UI (Streamlit) | 예정 |
| 2.3.0 | app (FastAPI 서버) | 예정 |
| 2.4.0 | user config, id/pw | 예정 |
| 2.5.0 | server deploy | 예정 |

자세한 계획은 [`ver2.0.1_+Multi-turn+LangChain/PLAN.md`](ver2.0.1_+Multi-turn+LangChain/PLAN.md),
